// Seed dữ liệu nếu localStorage trống
if (!localStorage.getItem("students")) {
    localStorage.setItem("students", JSON.stringify([
      { name: "Nguyễn Văn A", age: 20, score: 8.5 },
      { name: "Trần Thị B", age: 19, score: 6.0 }
    ]));
  }
  ...
  function renderStudents(filteredStudents = null) {
    ...
    if (students.length === 0) {
      studentList.innerHTML = "<li>Không có sinh viên nào</li>";
      return;
    }
